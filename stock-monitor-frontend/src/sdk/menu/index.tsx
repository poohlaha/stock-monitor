    ...
    return (
      ...
      >
        ...
        <div className="h-12 w100 flex-align-center fixed bottom-0 background pl-2 pr-2">
          <div className="flex-align-center">
            <div
              className="svg-box w-8 h-8 p-2 bg-menu-hover cursor-pointer rounded-md flex-align-center"
          ...
          <div className="flex-1 flex-center">
            <Button className="m-ant-button ml-2" onClick={async () => await onShowMainWindow()}>
              打开主界面
            </Button>
          </div>
